Step 1: client sends request to server 1.1 Client generates random number R1 and sends it to server 1.2 Client tells server which encryption algorithm it can support
